...
namespace Astrarium.Controls
{
    ...
    public class Markdown : DependencyObject
    {
        ...
        // Using a DependencyProperty as the backing store for ListItemStyle.  This enables animation, styling, binding, etc...
        public static readonly DependencyProperty ListStyleProperty =
            DependencyProperty.Register("ListStyle", typeof(Style), typeof(Markdown), new PropertyMetadata(null));

        // Using a DependencyProperty as the backing store for ListItemStyle.  This enables animation, styling, binding, etc...
        public static readonly DependencyProperty ListItemStyleProperty =
            DependencyProperty.Register("ListItemStyle", typeof(Style), typeof(Markdown), new PropertyMetadata(null));
    ...
    RegexOptions.Multiline | RegexOptions.IgnorePatternWhitespace | RegexOptions.Compiled);
        ...
        private ListItem ListItemEvaluator(Match match)
        {
            ...
            {
                listItem = Create<ListItem, Block>(RunBlockGamut(item));  
            }
            else
            {
