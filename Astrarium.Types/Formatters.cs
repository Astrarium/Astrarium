...
namespace Astrarium.Types
{
    ...
    public class ConstellationFormatter : IEphemFormatter
    {
    ...
    public class HMSAngleFormatter : IEphemFormatter
    {
    ...
    public class PhaseFormatter : IEphemFormatter
    {
        public string Format(object value)
        {
            double phase = 0;
    ...
    public class DayOfWeekFormatter : IEphemFormatter
    {
        public string Format(object value)
        {
            if (value is DayOfWeek day)
                return CultureInfo.CurrentCulture.DateTimeFormat.DayNames[(int)day].ToUpperFirstLetter();
            else
                return "";
        }
    }
    ...
    public class TimeFormatter : IEphemFormatter, ITimeInstantFormatter
    {
        ...
        public TimeFormatter() : this(withSeconds: false) { }
    ...
    public class DurationFormatter : IEphemFormatter
    {
        public string Format(object value)
        {
    ...
    public class MonthYearFormatter : AbstractDateFormatter, IEphemFormatter
    {
        public string Format(object value)
        {
            Date d = (Date)value;
    ...
    public class VisibilityDurationFormatter : IEphemFormatter
    {
        public string Format(object value)
        {
    ...
    public class VisibilityPeriodFormatter : IEphemFormatter
    {
        public string Format(object value)
        {
    ...
    public class TimeSpanFormatter : IEphemFormatter
    {
        public string Format(object value)
        {
